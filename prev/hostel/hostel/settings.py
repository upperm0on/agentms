...
SECRET_KEY = 'django-insecure-9sl0ysrh+0%bcvst9q74c@6v=69vjoq#vdrkz1lnwzc7o#u=a1'
...
# Add this to link client ID and secret
...
Q_CLUSTER = {
    ...
    'queue_limit': 50,
    'bulk': 10,
    'orm': 'default',  # Uses your Django DB as the broker (no Redis needed)
}

CORS_ALLOWED_ORIGINS = [
    "https://hosttelz.com",
    "http://localhost:5173",  # Consumer React App
    "http://127.0.0.1:5173",
    "http://localhost:5174",  # Admin React App
    "http://127.0.0.1:5174",
    "http://localhost:3000",  # Alternative ports
    "http://127.0.0.1:3000",
    "http://localhost:3001",  # Manager React App
    "http://127.0.0.1:3001",
    "http://localhost:3002",  # Manager React App (alternative port)
    "http://127.0.0.1:3002",
]
